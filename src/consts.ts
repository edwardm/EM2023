...
export const SITE_TITLE = "Edward Margallo - Sr. UX Designer, Product Designer and Design Systems Lead";
export const MY_NAME = "Edward Margallo";
export const MY_TITLE = "Sr. UX Designer, Product Designer and Design Systems Lead";
